...
class FaceAction:
    ...
    (lStart, lEnd) = face_utils.FACIAL_LANDMARKS_68_IDXS["left_eye"]   #checking left eye
    (rStart, rEnd) = face_utils.FACIAL_LANDMARKS_68_IDXS["right_eye"]    #checking right eye
    (mStart, mEnd) = face_utils.FACIAL_LANDMARKS_68_IDXS["mouth"]       #checking Mouth
    K = [6.5308391993466671e+002, 0.0, 3.1950000000000000e+002,
         0.0, 6.5308391993466671e+002, 2.3950000000000000e+002,     #coordinates for checking
         0.0, 0.0, 1.0]
    ...
    def drowsy(self, frame):
        ...
        for subject in subjects:
            ...
            leftEAR = self.eye_aspect_ratio(leftEye)   #checking left eye

            rightEAR = self.eye_aspect_ratio(rightEye)  #checking left eye
  ...
  def head_pose(self, frame):
        ...
        if(len(face_rects) > 0):
            ...
            return 1
    # function for checking head pose
